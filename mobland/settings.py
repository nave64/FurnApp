...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'site_module.context_processors.site_settings',  # Site settings context processor
            ],
        },
    },
]
...
RECAPTCHA_PUBLIC_KEY = os.getenv('RECAPTCHA_PUBLIC_KEY', '6LcSisgrAAAAABfKZ7UFE9rg1uMEwfGm1Fr0SsJI')
RECAPTCHA_PRIVATE_KEY = os.getenv('RECAPTCHA_PRIVATE_KEY', '6LcSisgrAAAAANkf7Yy1gWjtzSlFQ9Af5T6GAs_j')
NOCAPTCHA = True
